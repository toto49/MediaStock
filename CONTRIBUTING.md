...
- **Service (`com.eseo.mediastock.service`)** : Contient toute la logique métier. **Les contrôleurs ne doivent jamais
  appeler les DAO directement.** Ils doivent passer par les services.
- **Controller (`com.eseo.mediastock.controller`)** : Gère l'interface graphique JavaFX. La logique métier y est
